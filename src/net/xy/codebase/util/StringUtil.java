...
public class StringUtil {
	...
	public StringUtil(final StringBuilder sb) {
		this.sb = sb;
	}
	...
	public StringUtil append(final char[] chars) {
		sb.append(chars);
		return this;
	}

	public StringUtil append(final char[] chars, final int start, final int length) {
		sb.append(chars, start, length);
		return this;
	}

	public StringUtil append(final char ch) {
		sb.append(ch);
		return this;
	}

	public StringUtil append(final double value) {
		sb.append(value);
		return this;
	}

	public StringUtil append(final float value) {
		sb.append(value);
		return this;
	}

	public StringUtil append(final int value) {
		sb.append(value);
		return this;
	}

	public StringUtil append(final long value) {
		sb.append(value);
		return this;
	}

	public StringUtil append(final Object value) {
		sb.append(value);
		return this;
	}

	public StringUtil append(final String string) {
		sb.append(string);
		return this;
	}

	public StringUtil append(final boolean value) {
		sb.append(value);
		return this;
	}

	public StringUtil delete(final int start, final int end) {
		sb.delete(start, end);
		return this;
	}

	public StringUtil deleteCharAt(final int location) {
	...
	public StringUtil insert(final int index, final char[] chars) {
		sb.insert(index, chars);
		return this;
	}

	public StringUtil insert(final int index, final char[] chars, final int start, final int length) {
		sb.insert(index, chars, start, length);
		return this;
	}

	public StringUtil insert(final int index, final char ch) {
		sb.insert(index, ch);
		return this;
	}

	public StringUtil insert(final int index, final double value) {
		sb.insert(index, value);
		return this;
	}

	public StringUtil insert(final int index, final float value) {
		sb.insert(index, value);
		return this;
	}

	public StringUtil insert(final int index, final int value) {
		sb.insert(index, value);
		return this;
	}

	public StringUtil insert(final int index, final long value) {
		sb.insert(index, value);
		return this;
	}

	public StringUtil insert(final int index, final Object value) {
		sb.insert(index, value);
		return this;
	}

	public StringUtil insert(final int index, final String string) {
		sb.insert(index, string);
		return this;
	}

	public StringUtil insert(final int index, final boolean value) {
		sb.insert(index, value);
		return this;
	}
	...
	public StringUtil replace(final int start, final int end, final String string) {
	...
	public StringUtil append(final StringBuffer buffer) {
		sb.append(buffer);
		return this;
	}

	public StringUtil append(final CharSequence sequence) {
		sb.append(sequence);
		return this;
	}

	public StringUtil append(final CharSequence sequence, final int start, final int end) {
		sb.append(sequence, start, end);
		return this;
	}

	public StringUtil insert(final int index, final CharSequence sequence) {
		sb.insert(index, sequence);
		return this;
	}

	public StringUtil insert(final int index, final CharSequence sequence, final int start, final int end) {
		sb.insert(index, sequence, start, end);
		return this;
	}
	...
	public StringUtil padRight(final int amn, final String str) {
		append(str);
		for (int i = Math.min(str.length(), amn); i <= amn; i++)
			append(' ');
		return this;
	}

	public StringUtil padRight(final int amn, final Object obj) {
		final int len = length();
		append(obj);
		for (int i = Math.min(length() - len, amn); i <= amn; i++)
			append(' ');
		return this;
	}

	public StringUtil padLeft(final int amn, final int i) {
		sb.append(i, amn, ' ');
		return this;
	}

	public StringUtil padLeft(final int amn, final long l) {
		sb.append(l, amn, ' ');
		return this;
	}
	...
	private static class StringBuilder implements Appendable, CharSequence {
		...
		/**
		 * @return the number of characters required to represent the specified
		 *         value with the specified radix
		 */
		...
		private void enlargeBuffer(final int min) {
			final int newSize = (chars.length >> 1) + chars.length + 2;
		...
		final void append0(final char[] value) {
			final int newSize = length + value.length;
			if (newSize > chars.length)
				enlargeBuffer(newSize);
		...
		final void append0(final String string) {
			...
			final int newSize = length + adding;
			if (newSize > chars.length)
				enlargeBuffer(newSize);
		...
		final void deleteCharAt0(final int location) {
			...
			final int count = length - location - 1;
			if (count > 0)
		 ...
		 * requiring the internal buffer to be enlarged. The general policy of
		 * this method is that if the {@code minimumCapacity} is larger than the
		 * current {@link #capacity()}, then the capacity will be increased to
		 * the largest value of either the {@code minimumCapacity} or the
		 * current capacity multiplied by two plus two. Although this is the
		 * general policy, there is no guarantee that the capacity will change.
		 *
		 * @param min
		...
		public void ensureCapacity(final int min) {
			if (min > chars.length) {
				final int twice = (chars.length << 1) + 2;
				enlargeBuffer(twice > min ? twice : min);
			}
		}

		/**
		 * Copies the requested sequence of characters to the {@code char[]}
		 * passed starting at {@code destStart}.
		 *
		 * @param start
		 ...
		 * @param destStart
		 *            the inclusive start index of {@code dest} to begin copying
		 *            to.
		 * @throws IndexOutOfBoundsException
		 *             if the {@code start} is negative, the {@code destStart}
		 *             is negative, the {@code start} is greater than
		 *             {@code end}, the {@code end} is greater than the current
		 *             {@link #length()} or {@code destStart + end - begin} is
		...
		private void move(final int size, final int index) {
			if (chars.length - length >= size) {
				System.arraycopy(chars, index, chars, index + size, length - index); // index
																						// ==
																						// count
																						// case
																						// is
			...
			final int a = length + size, b = (chars.length << 1) + 2;
		...
		final void reverse0() {
			...
			for (int i = 0, mid = length / 2; i < mid; i++, --end) {
				final char frontLow = chars[i + 1];
				final char endHigh = chars[end - 1];
				final boolean surAtFront = allowFrontSur && frontLow >= 0xdc00 && frontLow <= 0xdfff
						&& frontHigh >= 0xd800 && frontHigh <= 0xdbff;
				if (surAtFront && length < 3)
					return;
				final boolean surAtEnd = allowEndSur && endHigh >= 0xd800 && endHigh <= 0xdbff && endLow >= 0xdc00
						&& endLow <= 0xdfff;
		...
		/**
		 * Sets the current length to a new value. If the new length is larger
		 * than the current length, then the new characters at the end of this
		 * object will contain the {@code char} value of {@code \u0000}.
		 *
		 * @param newLength
		...
		/**
		 * Returns the String value of the subsequence from the {@code start}
		 ...
		 * @return a String containing the subsequence.
		 * @throws StringIndexOutOfBoundsException
		 *             if {@code start} is negative, greater than {@code end} or
		 *             if {@code end} is greater than the current
		 *             {@link #length()}.
		 */
		...
		/**
		 * Returns a {@code CharSequence} of the subsequence from the
		 * {@code start} index to the {@code end} index.
		 *
		 * @param start
		 *            the inclusive start index to begin the subsequence.
		 * @param end
		...
		/**
		 * Searches for the first index of the specified character. The search
		 * for the character starts at the beginning and moves towards the end.
		 *
		 * @param string
		 *            the string to find.
		 * @return the index of the specified character, -1 if the character
		 *         isn't found.
		...
		/**
		 * Searches for the last index of the specified character. The search
		 * for the character starts at the end and moves towards the beginning.
		 *
		 * @param string
		 *            the string to find.
		 * @return the index of the specified character, -1 if the character
			...
			if (subCount <= length && start >= 0) {
				if (subCount > 0) {
					if (start > length - subCount)
						start = length - subCount; // count and subCount are
													// both
					// >= 1
					final char firstChar = subString.charAt(0);
					while (true) {
		...
		/**
		 * Trims off any extra capacity beyond the current length. Note, this
		 * method is NOT guaranteed to change the capacity of this object.
		 *
		 * @since 1.5
		 */
		public void trimToSize() {
			if (length < chars.length) {
				final char[] newValue = new char[length];
		 ...
		 *
		 * @param index
		 *            the index to the {@code char} code unit within this
		 *            object.
		 * @return the Unicode code point value.
		 * @throws IndexOutOfBoundsException
		...
		/**
		 * Returns the index that is offset {@code codePointOffset} code points
		 * from {@code index}.
		 *
		 * @param index
		 ...
		 * @return the index that is {@code codePointOffset} code points away
		 *         from index.
		 * @throws IndexOutOfBoundsException
		...
		/**
		 * Appends the string representation of the specified {@code boolean}
		 * value. The {@code boolean} value is converted to a String according
		 * to the rule defined by {@link String#valueOf(boolean)}.
		 *
		 * @param b
		 ...
		 * value. The {@code char} value is converted to a string according to
		...
		/**
		 * Appends the string representation of the specified {@code int} value.
		 * The {@code int} value is converted to a string without memory
		 * allocation.
		 *
		 * @param value
		 ...
		 *            the minimum number of characters to add
		 * @param prefix
		 *            the character to use as prefix
		 * @return this builder.
		 * @see String#valueOf(int)
		 */
		public StringBuilder append(int value, final int minLength, final char prefix) {
			...
			if (isNeg)
				value = -value;
			if (minLength > 1)
				for (int j = minLength - numChars(value, 10) - (isNeg ? 1 : 0); j > 0; --j)
					append(prefix);
			if (isNeg)
				append0('-');
			if (value >= 10000) {
		...
		/**
		 * Appends the string representation of the specified {@code long}
		 * value. The {@code long} value is converted to a string without memory
		 * allocation.
		 *
		 * @param value
		 *            the {@code long} value.
		...
		/**
		 * Appends the string representation of the specified {@code float}
		 * value. The {@code float} value is converted to a string according to
		 * the rule defined by {@link String#valueOf(float)}.
		 *
		 * @param f
		...
		/**
		 * Appends the string representation of the specified {@code double}
		 * value. The {@code double} value is converted to a string according to
		 * the rule defined by {@link String#valueOf(double)}.
		 *
		 * @param d
		 ...
		 * The {@code Object} value is converted to a string according to the
		 ...
		 * {@code CharSequence}. If the {@code CharSequence} is {@code null},
		 ...
		 * {@code CharSequence}. If the {@code CharSequence} is {@code null},
		 * then the string {@code "null"} is used to extract the subsequence
		 * from.
		 *
		 * @param csq
		 *            the {@code CharSequence} to append.
		 ...
		 *             {@code start} is greater than {@code end} or {@code end}
		 *             is greater than the length of {@code csq}.
		 */
		@Override
		...
		/**
		 * Appends the encoded Unicode code point. The code point is converted
		 * to a {@code char[]} as defined by {@link Character#toChars(int)}.
		 *
		 * @param codePoint
		 ...
		 * @return this builder.
		 * @throws StringIndexOutOfBoundsException
		 *             if {@code start} is less than zero, greater than the
		 *             current length or greater than {@code end}.
		 */
		...
		/**
		 * Inserts the string representation of the specified {@code boolean}
		 * value at the specified {@code offset}. The {@code boolean} value is
		...
		/**
		 * Inserts the string representation of the specified {@code char} value
		 * at the specified {@code offset}. The {@code char} value is converted
		...
		/**
		 * Inserts the string representation of the specified {@code int} value
		 * at the specified {@code offset}. The {@code int} value is converted
		 * to a String according to the rule defined by
		...
		/**
		 * Inserts the string representation of the specified {@code long} value
		 * at the specified {@code offset}. The {@code long} value is converted
		 * to a String according to the rule defined by
		...
		/**
		 * Inserts the string representation of the specified {@code float}
		 * value at the specified {@code offset}. The {@code float} value is
		 * converted to a string according to the rule defined by
		...
		/**
		 * Inserts the string representation of the specified {@code double}
		 * value at the specified {@code offset}. The {@code double} value is
		 * converted to a String according to the rule defined by
		...
		/**
		 * Inserts the string representation of the specified {@code Object} at
		 * the specified {@code offset}. The {@code Object} value is converted
		 * to a String according to the rule defined by
		...
		/**
		 * Inserts the string representation of the specified {@code char[]} at
		 * the specified {@code offset}. The {@code char[]} value is converted
		 * to a String according to the rule defined by
		 * {@link String#valueOf(char[])}.
		 *
		 * @param offset
		 ...
		 * {@code char[]} at the specified {@code offset}. The {@code char[]}
		 ...
		 * @throws StringIndexOutOfBoundsException
		 *             if {@code offset} is negative or greater than the current
		 *             {@code length()}, or {@code strOffset} and {@code strLen}
		 ...
		 * {@link CharSequence#toString()}. If {@code s} is {@code null}, then
		 * the String {@code "null"} is inserted.
		 *
		 * @param offset
		 *            the index to insert at.
		 * @param s
		 ...
		 * {@code CharSequence} is {@code null}, then the string {@code "null"}
		...
		public StringBuilder replace(final String find, final String replace) {
			final int findLength = find.length(), replaceLength = replace.length();
			int index = 0;
			while (true) {
		...
		public int hashCode() {
			...
			int result = 1;
			result = prime + length;
			result = prime * result + Primitive.hashCode(chars);
			return result;
		}
